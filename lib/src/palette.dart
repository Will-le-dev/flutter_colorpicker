...
class _SliderLayout extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    ...
    positionChild(track, Offset(0.0, size.height * 0.4));
    layoutChild(
      thumb,
      BoxConstraints.tightFor(width: 3.0, height: size.height / 7),
    );
    ...
    return LayoutBuilder(builder: (BuildContext context, BoxConstraints box) {
      ...
      switch (trackType) {
        ...
        case TrackType.lightness:
          ...
          break;
        case TrackType.red:
          thumbOffset += (box.maxWidth) * hsvColor.toColor().red / 0xff;
          thumbColor = hsvColor.toColor().withOpacity(1.0);
          break;
        case TrackType.green:
          thumbOffset += (box.maxWidth) * hsvColor.toColor().green / 0xff;
          thumbColor = hsvColor.toColor().withOpacity(1.0);
          break;
        case TrackType.blue:
          thumbOffset += (box.maxWidth) * hsvColor.toColor().blue / 0xff;
          thumbColor = hsvColor.toColor().withOpacity(1.0);
          break;
        case TrackType.alpha:
          thumbOffset += (box.maxWidth) * hsvColor.toColor().opacity;
